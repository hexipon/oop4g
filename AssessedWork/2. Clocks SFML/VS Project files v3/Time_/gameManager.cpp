...
gameManager::gameManager() : digClock(correctTime, sf::Vector2f(300, 0))
{
	...
	anClocks[CLOCK1] = new AnClock(CLOCK1, sf::Vector2f(0, 200));
	anClocks[CLOCK2] = new AnClock(CLOCK2, sf::Vector2f(300, 200));
	anClocks[CLOCK3] = new AnClock(CLOCK3, sf::Vector2f(600, 200));
	//setup digital clock
	digClock.init();
	setClocks();
