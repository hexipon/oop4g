...
const void Boss::colourChange()
{
	const int currentPlayerColour = Player::Get().GetColour();
	switch (colourType(currentPlayerColour))
	{
	case Ship::GREEN:
		colour = RED;
		break;
...
const void Boss::render()
{
	ship.Draw(_spritebatch);
	return void();
}

const void Boss::update()
{
...
const void Boss::hasCollided(const int _colour)
{
	switch (colour)
	{
	case Ship::GREEN:
...
const bool Boss::checkCollision(const Sprite & sprite)
{
