...
private:
	...
	const std::string textures[6] = { {"shieldPowerUpHigher"},{"shieldPowerUpLower"},{"healthPowerUpHigher"},{"healthPowerUpLower"},{"bulletPowerUpHigher"},{"bulletPowerUpLower"} };

public:
	powerUp(d3d& d3d_, DirectX::SpriteBatch& spritebatch_, float& deltaTime_,
	...
	const void hasCollidedWithPlayer();
